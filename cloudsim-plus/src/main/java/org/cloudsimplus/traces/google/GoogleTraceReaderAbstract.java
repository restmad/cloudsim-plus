...
abstract class GoogleTraceReaderAbstract<T> extends TraceReaderBase {
    /** A list of objects immediately created from the trace file.
     ...
     */
    protected final List<T> availableObjects;
    ...
    /**
     * Process the {@link #getFilePath() trace file} creating a List of objects
     * described in the file.
     *
     * <p>It returns the List of created objects that were available at timestamp 0 inside the trace file.</p>
     *
     * @return the List of created objects that were available at timestamp 0 inside the trace file.
     */
