 ...
 * In order to create such Hosts, the {@link GoogleMachineEventsTraceReader} requires
...
public final class MachineEvent {
     ...
     * Gets the machine ID.
     * @return
     * @see GoogleMachineEventsTraceReader.FieldIndex#MACHINE_ID
     */
    public int getMachineId() {
        return machineId;
    }

    protected MachineEvent setMachineId(final int machineId) {
